...
$sql = "SELECT MAX(Request_Form_Number) as 'max' FROM Request_Form ";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
    
$ID = $row['max'] + 1;
$sql = "INSERT INTO Request_Form VALUES($ID,'Recruiter')";
$conn->query($sql);
...
$sql = "SELECT MAX(Job_ID) as 'max' FROM Job ";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$ID = $row['max'] + 1;
$sql = "INSERT INTO Job VALUES($ID,$jType,$jName)";
$conn->close();
